...
export default function HomePage() {
  ...
  const getProfileData = async () => {
    ...
    axios
      .get(`${process.env.REACT_APP_BACKEND_BASEURL}/api/user`, {
        headers: {
  ...
  const getUserFavouriteCuisines = () => {
    const accessToken = localStorage.getItem("token");
    axios
      .get(`${process.env.REACT_APP_BACKEND_BASEURL}/api/user/fav-cuisines`, {
        headers: {
          "auth-token": accessToken,
        },
      })
  ...
  const getUserFavoriteRecipes = async () => {
    const accessToken = localStorage.getItem("token");
    axios
      .get(`${process.env.REACT_APP_BACKEND_BASEURL}/api/user/fav-recipes`, {
        headers: {
          "auth-token": accessToken,
        },
      })
  ...
  const getUserFeeds = async () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_BACKEND_BASEURL}/api/user/get-cuisine-feed`,
        {
          headers: {
            "auth-token": accessToken,
          },
  ...
  const createALike = (recipeId: string) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_BACKEND_BASEURL}/api/user/add-fav-recipe/${recipeId}`,
        data,
        {
          headers: {
  ...
  const deleteALike = (recipeId: string) => {
    ...
    axios
      .delete(
        `${process.env.REACT_APP_BACKEND_BASEURL}/api/user/del-fav-recipe/${recipeId}`,
        {
          headers: {
            "Content-Type": "application/json",
            "auth-token": accessToken,
