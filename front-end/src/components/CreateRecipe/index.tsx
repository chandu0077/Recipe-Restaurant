...
const CreateRecipe: React.FC<Props> = ({
  ...
  const createRecipe = (data: IRecipeForm) => {
    ...
    axios
      .post(`${process.env.REACT_APP_BACKEND_BASEURL}/api/recipe/`, data, {
        headers: {
  ...
  const editRecipe = (data: IRecipeForm) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_BACKEND_BASEURL}/api/recipe/${data._id}`,
        data,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const getAllCuisines = async () => {
    ...
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_BACKEND_BASEURL}/api/cuisine/`,
        {
          headers: {
            "auth-token": accessToken,
          },
